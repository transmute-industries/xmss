...
export const getGo = () => {
  ...
  if (!global.TextEncoder && global.require) {
    global.TextEncoder = global.require('util').TextEncoder;
  }
  ...
  if (!global.TextDecoder && global.require) {
    global.TextDecoder = global.require('util').TextDecoder;
  }
  ...
  global.Go = class {
    ...
    _resolveExitPromise: (value: unknown) => void = () => undefined;
    _pendingEvent: null;
    ...
    _makeFuncWrapper(id) {
      const go: any = this;
      return function () {
        const event: any = { id: id, this: go, args: arguments };
